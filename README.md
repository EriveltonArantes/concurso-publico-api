...
# 2. Listar registros
curl -H "Authorization: Bearer $TOKEN" http://localhost:8080/api/concursos
...
|----------|---------|---------|
| `/api/concursos` | GET / POST / PUT / DELETE | CRUD de Concurso |
| `/api/candidatos` | GET / POST / PUT / DELETE | CRUD de Candidato |
